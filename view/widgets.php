...
<div id="content" class="span10">
    ...
    <div class="row-fluid">
        ...
        <div class="box span4" onTablet="span6" onDesktop="span4">
            <div class="box-header">
                <h2><i class="icon-user"></i>Last Users</h2>
                <div class="box-icon">
                    <a href="#" class="btn-minimize"><i class="icon-chevron-up"></i></a>
                    <a href="#" class="btn-close"><i class="icon-remove"></i></a>
                </div>
    ...
    <div class="row-fluid">
        ...
        <div class="box span12">
            <div class="box-header">
                <h2><i class="icon-list"></i>Support tickets</h2>
                <div class="box-icon">
                    <a href="#" class="btn-minimize"><i class="icon-chevron-up"></i></a>
                    <a href="#" class="btn-close"><i class="icon-remove"></i></a>
                </div>
    ...
    <div class="row-fluid">
        <div class="span3 smallchart blue box mobileHalf">
        ...
        <div class="span3 smallchart red box mobileHalf">
        ...
        <div class="span3 smallchart green box mobileHalf">
        ...
        <div class="span3 smallchart yellow box mobileHalf">
