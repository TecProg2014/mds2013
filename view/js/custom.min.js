...
function init_masonry() {
    ...
    b.imagesLoaded(function() {
        b.masonry({itemSelector: ".masonry-thumb", gutterWidth: a, isAnimated: true, columnWidth: function(e) {
                var d = (e / c | 0);
                var f = (((e - (d - 1) * a) / d) | 0);
                if (e < c) {
                    f = e
...
function calendars() {
    ...
    $(".calendar-small").fullCalendar({header: {right: "title", left: "prev,next,today"}, defaultView: "month", editable: true, events: [{title: "All Day Event", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 17), allDay: true}, {title: "Long Event", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 15, 11, 30, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 10, 12, 30, 0)}, {id: 999, title: "Repeating Event", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 9, 8, 0, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 9, 10, 0, 0), allDay: false}, {id: 999, title: "Repeating Event", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 2, 8, 0, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate() - 2, 10, 0, 0), allDay: false}, {title: "Meeting", start: new Date(b.getFullYear(), b.getMonth(), b.getDate(), 11, 30, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate(), 12, 30, 0), allDay: false}, {title: "Lunch", start: new Date(b.getFullYear(), b.getMonth(), b.getDate(), 14, 0, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate(), 15, 30, 0), allDay: false}, {title: "Birthday Party", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() + 1, 19, 30, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate() + 1, 22, 30, 0), allDay: false}, {title: "Click for Google", start: new Date(b.getFullYear(), b.getMonth(), b.getDate() + 10, 14, 30, 0), end: new Date(b.getFullYear(), b.getMonth(), b.getDate() + 11, 12, 30, 0), url: "http://google.com/"}], dayClick: function(g, j, f, d) {
